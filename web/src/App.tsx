...
const COPY = {
  ...
  zh: {
    title: 'About Sijie',
    paragraphs: [
      '我是蔡斯杰——一个刚结束学生生涯的探索者。我常年和数学、物理、运动、网络、电子竞技打交道，喜欢研究并探寻每种领域的技能，创造和探索每一个未来的可能。',
    ],
  },
}
    ...
    <>
      ...
      <motion.div className="hero-chrome" style={{ opacity: heroChromeOpacity }} aria-hidden="true">
        ...
        <div className="hero-meta hm-tl">
          <span className="hm-name">Jason 蔡斯杰</span>
          <span>数学与物理双主修</span>
        </div>
        <div className="hero-meta hm-tr">Portfolio — 2026</div>
        <div className="hero-meta hm-bl">Math · Physics · Media</div>
        <div className="hero-meta hm-right">University of Toronto</div>
      </motion.div>
